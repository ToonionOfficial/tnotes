...
mod tests {
    ...
    fn test_sync_apply_new_and_conflict() {
        ...
        new_note_b.update("Title B", "Updated Body B", "Updated Searchable B", None, "dev_b");
    ...
    fn test_process_sync_envelope_roundtrip() {
        ...
        let note_a = Note::new("Server Note", "From dev_a", "Searchable A", None, "dev_a", &user.id);
        ...
        let note_b = Note::new("Client Note", "From dev_b", "Searchable B", None, "dev_b", &user.id);
