...
export const NoteActionSheet = forwardRef<NoteActionSheetRef, NoteActionSheetProps>(
  function NoteActionSheet(
    ...
    const previewText =
      "snippet" in note && note.snippet ? stripHtml(note.snippet) : stripHtml(note.body)
        ...
        <BottomSheetView className="px-5 pb-8 pt-2">
          ...
          <View className="mb-3 px-1">
            <View className="flex-row items-center gap-2">
              {!isTrash && note.pinned && <Pin size={12} color="#CABEFF" fill="#CABEFF" />}
            ...
            {!isTrash && onTogglePin && (
              ...
              >
                <View className="flex-row items-center gap-3">
                  <Pin size={19} color="#CABEFF" fill={note.pinned ? "#CABEFF" : "none"} />
